...
public class walls {
	...
	public walls(int wallAmount, String WallLoc, String WallType, double WallHeight, double wallLength, HashMap <String, String> Brickstype) {
	...
	public void display() {
		System.out.println("------------------------------------------------------------------------------------");
		System.out.println("\t"+"Wall's Locations"+"\t\t"+"Height -  Width  - Type of Wall");
		System.out.println("------------------------------------------------------------------------------------");
